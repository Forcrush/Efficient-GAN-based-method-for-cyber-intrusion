...
# network file
import bigan.ali_utilities as GAN
# data preprocess file
import data.ali as data
...
def create_logdir(method, weight, rd):
    return "bigan/train_logs/ali/{}/{}/{}".format(weight, method, rd)
...
def train_and_test(nb_epochs, weight, method, degree, dataset, random_seed):
    ...
    # Placeholders
    input_pl = tf.placeholder(tf.float32, shape=(None, 16), name="input")
    ...
    with sv.managed_session() as sess:
        ...
        fill = np.ones([batch_size - size, 16])
